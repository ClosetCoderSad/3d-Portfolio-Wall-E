...
const Position = () => {
  return (
    <div className="absolute top-12 left-28 z-40 cursor-default font-medium text-white text-[16px] xs:text-[20px] sm:text-[30px] md:text-[36px] 2xl:text-[66px] leading-[32px] 2xl:leading-[40px] w-full flex justify-center items-center">
      <div className="absolute inset-0 top-[-30px] sm:top-[-10px] lg:top-0 flex flex-col">
        ...
        <div className="text second absolute left-1 md:left-2 2xl:left-4 flex" aria-label="Content Creator">
          {produceSpans("CS Freshman", "animate-textRotate2")}
        </div>
      </div>
    </div>
  );
